...
\title{\huge Empirical Best Predictor}
\author{\large Felix Skarke, Enno Tammena, Christian Koopmann}
\institute{Freie Universität Berlin} % (oder halt Berlin)
...
\begin{block}{Erklärung Vorgehen  \Pheight}
\begin{enumerate} % für Stichpunkte
...
\begin{column}{.3\linewidth}
\begin{block}{Übersicht Genetic Matching Algorithmus\Pheight}
